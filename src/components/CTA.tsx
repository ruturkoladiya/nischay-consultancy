    ...
    <section className="w-full min-w-0 py-20 md:py-40 px-5 sm:px-6 md:px-8 text-center bg-soft-gray border-t border-gray-border/40">
      ...
      >
        ...
        <p className="text-lg text-gray-600 font-light mb-12 max-w-4xl leading-relaxed">
          Whether you are planning a residential space, infrastructure
          development, commercial development, or urban transformation, Nischay
          Consultancy is committed to delivering solutions that combine
          innovation, engineering excellence, and thoughtful design.
        </p>
