  ...
  return (
    <section className="w-full min-w-0 py-20 md:py-32 px-5 sm:px-6 md:px-16 border-t border-gray-border/40 bg-white">
      <div className="container mx-auto max-w-7xl flex flex-col items-center">
        <p className="text-xs tracking-widest uppercase text-gray-500 mb-6">Process Section</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 w-full">
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col border-t border-gray-border/60 pt-6 group">
