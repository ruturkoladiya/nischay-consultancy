  ...
  return (
    <section className="w-full min-w-0 py-20 md:py-32 px-5 sm:px-6 md:px-16 border-t border-gray-border/40 bg-white">
      <div className="container mx-auto max-w-7xl flex flex-col items-center">
        ...
        <h2 className="text-4xl md:text-5xl font-serif leading-tight mb-20">
          Our Approach
        </h2>
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              <span className="text-5xl font-serif text-gray-200 mb-6 group-hover:text-black transition-colors duration-500">
                0{index + 1}
              </span>
