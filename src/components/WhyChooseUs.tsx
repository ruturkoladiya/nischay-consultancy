  ...
  const features = [
    {
      ...
      className:
        "md:col-span-2 md:row-span-2 relative group overflow-hidden text-white flex flex-col justify-end p-8 md:p-12",
    },
    {
      ...
      className:
        "md:col-span-1 md:row-span-1 relative group overflow-hidden text-white flex flex-col justify-end p-8 md:p-10",
    },
    {
    ...
    },
    {
      ...
      className:
        "md:col-span-1 md:row-span-1 relative group overflow-hidden text-white flex flex-col justify-end p-8",
    },
    {
      ...
      className:
        "md:col-span-2 md:row-span-1 relative group overflow-hidden text-white flex flex-col justify-end p-8 md:p-10",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-serif leading-tight">
              Why Nischay Consultancy
            </h2>
          </div>
          <p className="text-lg text-gray-600 font-light max-w-md leading-relaxed">
            Determination in Every Development. We build with precision,
            ensuring every space serves a profound purpose.
          </p>
        </div>
