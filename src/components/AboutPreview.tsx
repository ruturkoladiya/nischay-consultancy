...
export default function AboutPreview() {
  return (
    <section
      id="about"
      className="w-full min-w-0 py-16 md:py-36 px-5 sm:px-6 md:px-8 bg-white overflow-hidden relative border-t border-gray-border/40"
    >
      <div className="container mx-auto max-w-5xl flex flex-col items-center text-center">
        ...
        <div className="space-y-6 text-lg text-gray-600 font-light max-w-4xl leading-relaxed mb-10">
          <p>
            Nischay Consultancy is a multidisciplinary consultancy firm based in
            Gandhinagar, dedicated to delivering comprehensive solutions in
            architecture, engineering, interior design, urban planning, and
            Project Management Consultancy services.
          </p>
          <p>
            Our approach combines creative thinking with practical execution to
            ensure every development is not only visually impactful but also
            structurally efficient and sustainable. Whether it’s a residential
            development, public infrastructure, urban streetscape, or interior
            space, we focus on creating designs that balance aesthetics,
            usability, and long-term value.
          </p>
          <p>
            Every development we undertake is driven by collaboration, attention
            to detail, and a passion for building spaces that truly make a
            difference.
          </p>
        </div>
