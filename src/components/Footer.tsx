...
export default function Footer() {
  const mapSearchUrl =
    "https://www.google.com/maps/search/?api=1&query=804,+Synergy+Space,+Opp.+Aashka+Hospital,+Beside+D-mart,+Sargasan,+Gandhinagar+382421";

  return (
    <footer
      id="contact"
      className="w-full min-w-0 bg-white pt-20 md:pt-32 pb-8 px-5 sm:px-6 md:px-16 border-t border-gray-border/40"
    >
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col lg:flex-row justify-between mb-24 gap-16">
          <div className="max-w-md">
            ...
            <p className="text-gray-500 font-light text-sm leading-relaxed mb-4 font-medium uppercase tracking-widest text-xs text-black break-words">
              Architecture | Structural Engineering | Urban Planning | Interior
              Design | Project Management | Project Management Consultancy
              Services
            </p>
            <p className="text-gray-500 font-light text-sm leading-relaxed mb-8">
              Creating sustainable, efficient, and future-focused built
              environments with precision and purpose.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:info@nischayconsultancy.com"
                    className="text-sm font-light text-gray-500 hover:text-black"
                  >
                    info@nischayconsultancy.com
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-light text-gray-500 leading-relaxed max-w-[250px]">
                  804, Synergy Space,
                  <br />
                  Opp. Aashka Hospital, Beside D-mart,
                  <br />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-6 border-t border-gray-border/60 gap-8">
          ...
          <div className="flex gap-6 text-gray-400 tracking-wider text-xs font-medium">
            <a
              href="https://www.instagram.com/nischayconsultancy?igsh=MWhhZHh4c2IweWV3YQ%3D%3D&utm_source=qr"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/company/nischay-consultancy/"
              target="_blank"
              rel="noopener noreferrer"
